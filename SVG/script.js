...
interiorDetail.addEventListener("click", () => {
    alert("The body is an exoskeleton, which is to say, the body panels are welded together to form the structure of the truck. This is not body-on-frame construction like a conventional pickup truck, nor a collection of panels bolted and welded into a unitized body shell like a typical car or crossover.")
})
...
windows.addEventListener("click", () => {
    alert("Tesla Armor Glass (aka Durable Glass for Vehicle) is a two-ply laminated glass product: A multilayer glass stack for a vehicle windshield with improved durability. The multilayer glass stack includes an external-facing glass layer, an internal-facing glass layer, and an adhesive interlayer positioned between the external-facing and internal-facing glass layers. The external-facing glass layer comprises borosilicate.")
})

tyres.addEventListener("click", () => {
    alert("The first aftermarket wheel designed for the Telsa Cybertruck through a collaboration between Unplugged Performance and accomplished sports car designer Sasha Selipanov, with all the right brutalist neo-futuristic design notes and incredible strength to take you anywhere on Earth or beyond.")
})